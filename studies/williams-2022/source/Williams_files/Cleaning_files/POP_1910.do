...
*** CLEANING FILE ***;
** Input data file: POP_1910_temp from IPUMS NHGIS;
** Creates analysis data file: POP_1910_NHGIS to be used in Createmain.do;

global infile = "Input_data";
global outfile = "Analysis_data";


use "$infile/POP_1910_temp";
...
generate Black_POP_1910 = a30003 + a30004;
generate White_POP_1910 = a30001 + a30002;

** Replace Dade fips which was later changed to Miami-Dade fips code for merge;
replace fips = 12086 if fips == 12025;

keep fips Black_POP_1910 White_POP_1910;

save "$outfile/POP_1910_NHGIS", replace;
