...
/*-------------------------------FIGURE A7-------------------------------------*/
/*--------------------------1936-40 as base group------------------------------*/
 
* Years of Education

use "$MainDir/data/results/1936-40_base/edu_coeff_2000_ipums_1of2.dta", clear
...
graph twoway (connected coef year, clpattern(solid) clwidth(mthick) msymbol(th) mcolor(red)) ///
			 ...
			 text(0.5 1958 "Panel A: Years of Schooling", place(n)) legend(off) ///
			 ytitle("Coef.of CR Intensity*Birth Cohort") ///
			 xlabel(1941 1946 1951 1956 1961 1966 1971 1976,labsize(small)) ///
			 ylabel(-0.5(0.2)0.7,labsize(small)) ///
			 xtitle("Birth Cohort") scheme(s1mono)							

graph export "$MainDir/data/results/1936-40_base/edu_gdid_5y_1of2.png", replace

* College Education

use "$MainDir/data/results/1936-40_base/edu_coeff_2000_ipums_2of2.dta", clear
...
graph twoway (connected coef year, clpattern(solid) clwidth(mthick) msymbol(th) mcolor(red)) ///
			 (rcap ci_upper ci_lower year, lcolor(blue)), ///
			 yline(0, lcolor(grey) lpattern(shortdash))  ///
			 text(2 1958 "Panel B: College Education", place(n)) legend(off) ///
			 ytitle("Coef.of CR Intensity*Birth Cohort") ///
			 xlabel(1941 1946 1951 1956 1961 1966 1971 1976,labsize(small)) ///
			 ylabel(-4(1)3,labsize(small)) ///
			 xtitle("Birth Cohort") scheme(s1mono)							

graph export "$MainDir/data/results/1936-40_base/edu_gdid_5y_2of2.png", replace

* Employment Status
 
use "$MainDir/data/results/1936-40_base/lab_coeff_2000_ipums_1of4.dta", clear
...
graph twoway (connected coef year, clpattern(solid) clwidth(mthick) msymbol(th) mcolor(red)) ///
			 (rcap ci_upper ci_lower year, lcolor(blue)), ///
			 yline(0, lcolor(grey) lpattern(shortdash))  ///
			 text(2 1958 "Panel A: Employment Status", place(n)) legend(off) ///
			 ytitle("Coef.of CR Intensity*Birth Cohort") ///
			 xlabel(1941 1946 1951 1956 1961 1966 1971 1976,labsize(small)) ///
			 ylabel(-4(1)3,labsize(small)) ///
			 xtitle("Birth Cohort") scheme(s1mono)							

graph export "$MainDir/data/results/1936-40_base/lab_gdid_5y_1of4.png", replace

* Number of Days Worked
 
use "$MainDir/data/results/1936-40_base/lab_coeff_2000_ipums_2of4.dta", clear
...
graph twoway (connected coef year, clpattern(solid) clwidth(mthick) msymbol(th) mcolor(red)) ///
			 (rcap ci_upper ci_lower year, lcolor(blue)), ///
			 yline(0, lcolor(grey) lpattern(shortdash))  ///
			 text(2 1958 "Panel B: Days Worked Last Week", place(n)) legend(off) ///
			 ytitle("Coef.of CR Intensity*Birth Cohort") ///
			 xlabel(1941 1946 1951 1956 1961 1966 1971 1976,labsize(small)) ///
			 ylabel(-4(1)3,labsize(small)) ///
			 xtitle("Birth Cohort") scheme(s1mono)							

graph export "$MainDir/data/results/1936-40_base/lab_gdid_5y_2of4.png", replace

* Professional Occupation
 
use "$MainDir/data/results/1936-40_base/lab_coeff_2000_ipums_3of4.dta", clear
...
graph twoway (connected coef year, clpattern(solid) clwidth(mthick) msymbol(th) mcolor(red)) ///
			 (rcap ci_upper ci_lower year, lcolor(blue)), ///
			 yline(0, lcolor(grey) lpattern(shortdash))  ///
			 text(2 1958 "Panel C: Professional Occupation", place(n)) legend(off) ///
			 ytitle("Coef.of CR Intensity*Birth Cohort") ///
			 xlabel(1941 1946 1951 1956 1961 1966 1971 1976,labsize(small)) ///
			 ylabel(-4(1)3,labsize(small)) ///
			 xtitle("Birth Cohort") scheme(s1mono)							

graph export "$MainDir/data/results/1936-40_base/lab_gdid_5y_3of4.png", replace

* Entrepreneur
 
use "$MainDir/data/results/1936-40_base/lab_coeff_2000_ipums_4of4.dta", clear
...
graph twoway (connected coef year, clpattern(solid) clwidth(mthick) msymbol(th) mcolor(red)) ///
			 (rcap ci_upper ci_lower year, lcolor(blue)), ///
			 yline(0, lcolor(grey) lpattern(shortdash))  ///
			 text(2 1958 "Panel D: Entrepreneur", place(n)) legend(off) ///
			 ytitle("Coef.of CR Intensity*Birth Cohort") ///
			 xlabel(1941 1946 1951 1956 1961 1966 1971 1976,labsize(small)) ///
			 ylabel(-4(1)3,labsize(small)) ///
			 xtitle("Birth Cohort") scheme(s1mono)							

graph export "$MainDir/data/results/1936-40_base/lab_gdid_5y_4of4.png", replace
