...
\draw[dotted] (axis cs:1/3,0) -- (axis cs:1/3,2);
...
\addplot[soldot] coordinates{(0.36,2)} node[above](){};
\addplot[soldot] coordinates{(0.36,1)} node[above](){};
\addplot[] coordinates{(0.36,1)} node[below](b) {};
\addplot[] coordinates{(0.36,2)} node[above](c) {};
\addplot[soldot] coordinates{(0.42,2)} node[above](){};
\addplot[soldot] coordinates{(0.42,1)} node[above](){};
\addplot[] coordinates{(0.42,1)} node[below](f) {};
\addplot[] coordinates{(0.42,2)} node[above](g) {};
\addplot[soldot] coordinates{(0.48,2)} node[above](){};
\addplot[soldot] coordinates{(0.48,1)} node[above](){};
\addplot[] coordinates{(0.48,1)} node[below](h) {};
\addplot[] coordinates{(0.48,2)} node[above](i) {};

\draw[>=latex, shorten >=0.1cm,shorten <=0.1cm, black,->] (b)--(c);
\draw[>=latex, shorten >=0.1cm,shorten <=0.1cm, black,->] (f)--(g);
\draw[>=latex, shorten >=0.1cm,shorten <=0.1cm, black,->] (h)--(i);
