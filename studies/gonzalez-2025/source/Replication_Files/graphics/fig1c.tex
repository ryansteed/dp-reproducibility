...
xtick={0,0.19,0.335,0.51,1},
xticklabels={0,$p_2$,$p_1$,$p_0$,1},
...
\addplot[name path=F,domain=0:1,solid, green] {(1/\d)*ln(exp(-\d*\O)/x-exp(-\d*\Y)/x + exp(-\d*\Y))};
\addlegendentry{$\alpha>0$}
\addplot[name path=F,domain=0:1,solid, black] {(((1-x)*\Y^\a-\O^\a)/x)^(1/\a)};
\addlegendentry{$\alpha=0$}
\addplot[name path=F,domain=0:1,solid, blue] {(1/\b)*ln(exp(-\b*\O)/x-exp(-\b*\Y)/x + exp(-\b*\Y))};
\addlegendentry{$\alpha<0$}
...
\draw[dotted] (axis cs:0.19,0) -- (axis cs:0.19,2);
\draw[dotted] (axis cs:.335,0) -- (axis cs:.335,2);
\draw[dotted] (axis cs:0.51,0) -- (axis cs:0.51,2);

% Fines
\addplot[domain=0:1,dashed,mark=none,black] {1};
\addplot[domain=0:1,dashed,mark=none,black] {2};
\addplot[soldot] coordinates{(0.19,2)} node[above](){};
\addplot[soldot] coordinates{(0.335,2)} node[above](){};
\addplot[soldot] coordinates{(0.51,2)} node[above](){};

\draw[>=latex,shorten >=0.05cm,shorten <=0.05cm, black,<-] (axis cs:0.335,0.1)--(axis cs:0.51,0.1);
\draw[>=latex,shorten >=0.05cm,shorten <=0.05cm, black,->] (axis cs:0.335,0.1)--(axis cs:0.19,0.1);
