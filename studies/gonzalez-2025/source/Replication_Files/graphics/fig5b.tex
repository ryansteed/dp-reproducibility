...
\draw[dotted] (axis cs:0.165,0) -- (axis cs:0.165,2);
...
\addplot[soldot] coordinates{(0.165,2)} node[above](){};

\draw[>=latex,shorten >=0.05cm,shorten <=0.05cm, black,->] (axis cs:0.335,0.1)--(axis cs:0.165,0.1);
