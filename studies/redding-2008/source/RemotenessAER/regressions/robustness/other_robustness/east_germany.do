...
**********************************************************************
**** This file generates the robustness test running the baseline ****
**** specification for East Germany as discussed in Section V.E   ****  
**** of the paper                                                 ****
**********************************************************************

log using regressions/robustness/other_robustness/logs/east_germany.log,replace

use regressions/robustness/other_robustness/data/RemotenessAER_Robustness_DDR.dta
so city year
