...
* Panel A
	...
	foreach subject in math ela {
		...
		*** EDITED by Ryan Steed
		estout m1_math m2_math m3_math m1_ela m2_ela m3_ela using "../../results/main_regressions_panelA.csv", keep(share_inperson share_hybrid) cells(`"b() se() t() p()"') stats(N r2 df_m df_r df_b df) notype abbrev begin(`"""') delimiter(`"",""') end(`"""') replace
		***
...
*Panel B: Interactions
	...
	*** EDITED by Ryan Steed
	estout m1_math m2_math m3_math m1_ela m2_ela m3_ela using "../../results/main_regressions_panelB.csv", keep(inperson_2021 hybrid_2021 c_black_yr_ip c_black_yr_hybrid c_hisp_yr_ip c_hisp_yr_hybrid c_lunch_yr_ip c_lunch_yr_hybrid) cells(`"b() se() t() p()"') stats(N r2 df_m df_r df_b df) notype abbrev begin(`"""') delimiter(`"",""') end(`"""') replace
	***
