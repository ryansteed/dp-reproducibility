...
collapse (sum) baby_death* mat_death*, by(year month code_mun)
reshape wide baby_death* mat_death*, i(year code_mun) j(month)
compress
save "$pathfiles_data/Workfiles/SIM_yearmonth.dta", replace
