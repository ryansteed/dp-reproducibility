	...
	preserve
		*save labels
		...
		collapse ///
			...
			exp_totexp`g' 	= 	ppexp_totexp${n} /// 	/!!!/	//tot exp
			exp_instr`g'	= 	ppexp_instr${n} ///  	/!!!/	//instruction
			exp_admin`g' 	= 	ppexp_admin${n} /// 	/!!!/	//admin
			exp_social`g'	= 	ppexp_social${n} ///  	/!!!/	//social serv.
			exp_infra`g'	= 	ppexp_infra${n} ///	  	/!!!/	//infrastructure
			exp_other`g' 	= 	ppexp_other${n} /// 	/!!!/	//other
			...
			rev_totalrev`g' = 	pprev_totalrev${n} ///	/!!!/	//total rev
			rev_tfedrev`g' 	= 	pprev_tfedrev${n} ///	/!!!/	//fed rev 
			rev_tstrev`g' 	= 	pprev_tstrev${n} ///	/!!!/	//state rev
			rev_tlocrev`g' 	= 	pprev_tlocrev${n} ///	/!!!/	//loc rev 
...
// ??? why exactly do we do the above step first? 
...
foreach f in exp_totexp exp_instr exp_admin exp_social exp_infra ///
	...
	*dollar differences
	...
	/*Could take each state's funding in the middle year and divide all the 
...
*SAVE
********************************************************************************
	//save "Derived/7-construct-measures-state_${date}", replace
