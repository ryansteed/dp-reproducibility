...
use compulsory_schooling_and_crime.dta
xtset state_county
merge m:1 year state_fips using MDA_Laws_timing.dta
***
...
eststo: xi:  xtreg total_crime1_rate age1618 mda18 mda18_age1618 i.year if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_totalcrime != 1 & count > 10 & (log_wage != . & log_income != . & popratio1618 != . & pop_dense_thou != . & popratio_male != . & popratio_black != . & agency_count != .) [pweight = ave_county_pop], fe cluster(state_fips)
*County FEs, Year FEs, and covariates
eststo: xi:  xtreg total_crime1_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_totalcrime != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)
...
*********************
*County FEs and Year FEs
eststo: xi:  xtreg property1_rate age1618 mda18 mda18_age1618 i.year if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_property1 != 1 & count > 10 & (log_wage != . & log_income != . & popratio1618 != . & pop_dense_thou != . & popratio_male != . & popratio_black != . & agency_count != .) [pweight = ave_county_pop], fe cluster(state_fips)
*County FEs, Year FEs, and covariates
eststo: xi:  xtreg property1_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_property1 != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)
*County FEs, Year FEs, covariates, and trends
...
*********************
*County FEs and Year FEs
eststo: xi:  xtreg violent1_rate age1618 mda18 mda18_age1618 i.year if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_violent1 != 1 & count > 10 & (log_wage != . & log_income != . & popratio1618 != . & pop_dense_thou != . & popratio_male != . & popratio_black != . & agency_count != .) [pweight = ave_county_pop], fe cluster(state_fips)
*County FEs, Year FEs, and covariates
eststo: xi:  xtreg violent1_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_violent1 != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)
*County FEs, Year FEs, covariates, and trends
...
*************************
*County FEs and Year FEs
eststo: xi:  xtreg total_drug_rate age1618 mda18 mda18_age1618 i.year if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_total_drug != 1 & count > 10 & (log_wage != . & log_income != . & popratio1618 != . & pop_dense_thou != . & popratio_male != . & popratio_black != . & agency_count != .) [pweight = ave_county_pop], fe cluster(state_fips)
*County FEs, Year FEs, and covariates
eststo: xi:  xtreg total_drug_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_total_drug != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)
*County FEs, Year FEs, covariates, and trends
eststo: xi:  xtreg total_drug_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_total_drug != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*** EDITED by Ryan Steed
estout using ../results/table4_male.csv, cells(`"b() se() t() p()"') stats(N r2 df_m df_r df_b df) notype abbrev begin(`"""') delimiter(`"",""') end(`"""') replace
eststo clear
exit
...
************************************************
*Larceny
eststo: xi:  xtreg larceny_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_larceny != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*Burglary
eststo: xi:  xtreg burglary_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_burglary != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*MVT
eststo: xi:  xtreg mvt_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_mvt != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*Arson
eststo: xi:  xtreg arson_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_arson != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*Murder
eststo: xi:  xtreg murder_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_murder != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*Rape
eststo: xi:  xtreg rape_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_rape != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*Robbery
eststo: xi:  xtreg robbery_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_robbery != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*Aggravated Assault
eststo: xi:  xtreg agg_assault_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_agg_assault != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*Simple Assault
eststo: xi:  xtreg other_assault_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_other_assault != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*Selling of drugs
eststo: xi:  xtreg drug_sale_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_drug_sale != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)

*Possession of drugs
eststo: xi:  xtreg drug_possess_rate age1618 mda18 mda18_age1618 mlda19 mlda20 mlda21 log_wage log_income popratio1315 popratio1618 pop_dense_thou popratio_male popratio_black agency_count i.year state_fe* if (age == 1315 | age == 1618) & male == 1 & flag_males != 1 & sd_flag_drug_possess != 1 & count > 10 [pweight = ave_county_pop], fe cluster(state_fips)
...
use compulsory_schooling_and_crime.dta
xtset state_county
merge m:1 year state_fips using MDA_Laws_lags_1.dta
***
...
order mda18_lag3 mda18_lag2 mda18_lag1, after(_merge_laws)
