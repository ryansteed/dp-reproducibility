* Do-file para generar la base que se utiliza para la Tabla XV (Panel B, Column 4)
...
drop if dup > 1
keep cod_com
merge 1:m cod_com using immigration_collapse_2
keep if _merge==3
drop _merge
...
cd "$conf_final"
save channels_OLS2_homicides, replace
