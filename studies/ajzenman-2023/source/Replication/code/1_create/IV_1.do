* Do-file para generar la base que se utiliza para las Tablas VII, VII, IX, X, XII (Panel A.1-A.3), XIII (Columns 1-3), A.4, A.5, A.6 (Panel A) y A.7 (Columns 1 and 3)
...
sort cod_com year
merge 1:1 cod_com year using FinalBase_permisos
keep if _merge==3
drop _merge
...
drop _merge
save FinalBase101_permisos2, replace
********************************************************
...
merge 1:1 cod_com using FinalBase101_permisos2
keep if _merge==3
drop _merge

cd "../../$final"
save enusc_IV, replace
cd "../.."
